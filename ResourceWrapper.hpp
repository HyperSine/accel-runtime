...
namespace ARL {
    ...
    public:
        ...
        static_assert(
            ...
            "[ARL::ResourceWrapper]: HandleType must be a POD type."
        );
    ...
    public:
        ...
        __ReturnType TransferAs() noexcept {
            static_assert(
                ...
                "[ARL::ResourceWrapper]: __ReturnType should also be a POD type, just like HandleType."
            );
    ...
    public:
        ...
        static_assert(
            std::is_trivial_v<HandleType> && std::is_standard_layout_v<HandleType>,
            "[ARL::ResourceWrapperEx]: HandleType must be a POD type."
        );
    ...
    public:
        ...
        __ReturnType TransferAs() noexcept {
            static_assert(
                std::is_trivial_v<__ReturnType> && std::is_standard_layout_v<__ReturnType>,
                "[ARL::ResourceWrapperEx]: __ReturnType should also be a POD type, just like HandleType."
            );
